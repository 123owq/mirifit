...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget _buildBody() {
    switch (_currentIndex) {
      case 0:
        return SingleChildScrollView( // 스크롤이 가능하도록
          child: Padding(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Column(
              children: [
                Text('소모칼로리', style: TextStyle(color: Colors.grey[400], fontSize: 14)),
                const SizedBox(height: 8),
                Row(
                  crossAxisAlignment: CrossAxisAlignment.baseline,
                  textBaseline: TextBaseline.alphabetic, // '285'와 'kcal' 높이 맞춤
                  children: [
                    const Text('285', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
                    const SizedBox(width: 4),
                    Text('kcal', style: TextStyle(color: Colors.grey[400], fontSize: 14)),
                  ],
                ),
              ],
            ),
            ...
            Column(
              children: [
                Text('총활동량', style: TextStyle(color: Colors.grey[400], fontSize: 14)),
                const SizedBox(height: 8),
                Row(
                  crossAxisAlignment: CrossAxisAlignment.baseline,
                  textBaseline: TextBaseline.alphabetic,
                  children: [
                    const Text('30', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
                    const SizedBox(width: 4),
                    Text('분', style: TextStyle(color: Colors.grey[400], fontSize: 14)),
                  ],
                ),
              ],
            ),
